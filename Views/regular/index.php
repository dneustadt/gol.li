                        ...
                        <div class="row service"<?php if (empty($service['handle'])): ?> style="display: none;"<?php endif; ?>>
                            ...
                            <div class="column url-pattern">
                                <?= sprintf(
                                    ...
                                    '<input type="text" data-id="' . $service['id'] . '" name="services[' . $service['id'] . ']" value="' . rawurlencode(@$service['handle']) . '">' .
                                    '</div>' .
                                    '<div class="column url-pattern">'
                                ); ?>
                            </div>
    ...
    <?php else: ?>
        ...
        <?php foreach (@$data['services'] as $service): ?>
            <div class="row service front">
                ...
                <div class="column">
                    <a href="<?= sprintf($service['url'], rawurlencode($service['handle'])); ?>" target="_blank">
                        <?= sprintf($service['url'], rawurlencode($service['handle'])); ?>
                    </a>
                </div>
